...
class DynamoDomoticzHandlerTest {
	 private static final String EXPECTED_CONTENT_TYPE = "application/json";
	    private static final String EXPECTED_RESPONSE_VALUE = "Hello World!, Olivier Maillet";
	    ...
	    void testHandleRequest() {
	        GatewayResponse response = (GatewayResponse) new DynamoDomoticzHandler().handleRequest(input, mockLambdaContext);
